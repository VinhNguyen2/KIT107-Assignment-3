...
{
	trace("get_row: get_row starts ");

	return (s->row);

	trace("get_row: get_row finishes");
}
...
{
	//COMPLETE ME!
	trace("getColumn: getColumn starts ");	

	//return column data field
	return (s->column);

	trace("getColumn: getColumn finishes");
...
{
	//COMPLETE ME!
	trace("setRow: setRow starts");	//for debug purposes only.
